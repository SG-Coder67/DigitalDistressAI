  ...
  if (changeInfo.status === 'loading' && changeInfo.url && changeInfo.url.startsWith('http')) {
    ...
    .then(data => {
      ...
      if (data.result === "malicious") {
        ...
        // This avoids the race condition where the tab redirects before the
        // notification has time to appear.
        // IMPORTANT: Make sure this file path is correct!
        // You need a folder named 'images' with 'icon128.png' inside it.
        ...
        // This happens immediately after scheduling the notification.
